"""
Configuração centralizada do Vaporeon Pentester Suite.

Todas as constantes, caminhos e parâmetros ficam aqui
para evitar valores hardcoded espalhados pelo projeto.
"""
...
# Documentação (Relatórios em PDF)
